...
public class UserDB {
	...
	public static User UpdateFN(String firstname1,String email) throws SQLException{
...
public static User UpdateLN(String lastname,String email) throws SQLException{
		User user=null;
